                    ...
                    if (i && me.controlMap.hasOwnProperty(i) && me.controlMap[i]) {
                        ...
                        if (String(ctr.isFormItem) !== 'false') {
                            if (ctr.getValue) {
                                ...
                                paramMap[formName] = (ctr.getMain ? ctr.getMain() : me.getDocument().getElementById(ctr.main)).value;
                            }
                            else if (ctr.controlMap) {
...
hui.define('hj_quicklogin', ['hui@0.0.1', 'hui_requester@0.0.1', 'hui_md5@0.0.1', 'hui_textinput@0.0.1', 'hui_button@0.0.1', 'hui_checkbox@0.0.1'], function () {
    ...
    hui.HJ_QuickLogin = function (options, pending) {
        ...
        // 监控事件接口
        this.monitorList = {};
        this.globalMonitorList = {};

        this.globalMonitorList['hj_reg_mobile_success'] = [];
        this.globalMonitorList['hj_reg_email_success'] = [];
        this.globalMonitorList['hj_reg'] = [];
        this.globalMonitorList['hj_reg_email_mobile'] = [];
        this.globalMonitorList['hj_reg_mobile_email'] = [];
        this.globalMonitorList['hj_reg_login'] = [];
        this.globalMonitorList['hj_reg_close'] = [];
        this.globalMonitorList['hj_reg_mobile_submit'] = [];
        this.globalMonitorList['hj_reg_mobile_sendsms'] = [];
        this.globalMonitorList['hj_reg_email_submit'] = [];
        this.globalMonitorList['hj_reg_login_submit'] = [];
        this.globalMonitorList['hj_reg_email_continue'] = [];
        this.globalMonitorList['hj_reg_email_success_active'] = [];

        this.fireGlobalMonitor = function (eventName) {
            var monitorList = this.globalMonitorList[eventName];
            if (monitorList && monitorList.length) {
                for (var i = 0, len = monitorList.length; i < len; i++) {
                    (Object.prototype.toString.call(monitorList[i]) === '[object Function]') && monitorList[i]();
                }
            }
        };
        this.addGlobalMonitor = function (eventName, handler) {
            this.globalMonitorList[eventName] = this.globalMonitorList[eventName] || [];
            this.globalMonitorList[eventName].push(handler);
        };

        this.addGlobalMonitor('hj_reg', function () { /* 注册沪江页展示            */
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 4);
            }
        });
        this.addGlobalMonitor('hj_reg_login', function () { /* 登录沪江页展示            */
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 2);
            }
        });
        this.addGlobalMonitor('hj_reg_mobile_success', function () { /* 手机注册成功页            */
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 10);
            }
        });
        this.addGlobalMonitor('hj_reg_email_success', function () { /* 邮箱注册成功页            */
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 11)
            }
        });

        this.addGlobalMonitor('hj_reg_login_submit', function () { /* 登录按钮事件              */
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 74);
            }
        });
        this.addGlobalMonitor('hj_reg_mobile_submit', function () { /* 手机号注册按钮事件        */
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 71);
            }
        });
        this.addGlobalMonitor('hj_reg_email_submit', function () { /* 邮箱注册按钮事件          */
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 72);
            }
        });
        this.addGlobalMonitor('hj_reg_email_success_active', function () { /* 邮箱激活按钮事件          */
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 77);
            }
        });
        this.addGlobalMonitor('hj_reg_email_continue', function () { /* 继续浏览按钮事件          */
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 76);
            }
        });
        this.addGlobalMonitor('hj_reg_close', function () { /* 关闭按钮事件              */
            if (typeof window.SendEvent !== 'undefined') {
                if (window.hjquicklogin.control.getByFormName('hj_reg_email_success').getMain().style.display === 'block') {
                    window.SendEvent(2, 92);
                }
            }
        });
        this.addGlobalMonitor('hj_reg_email_success_active', function () { /* 邮箱注册成功点HOT              */
            if (typeof window.SendEvent !== 'undefined') {
                window.SendEvent(2, 102);
            }
        });
        this.addGlobalMonitor('hj_reg_mobile_email', function () { /* 在手机注册页的邮箱注册点击*/
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 73);
            }
        });
        this.addGlobalMonitor('hj_reg_email_mobile', function () { /* 在邮箱注册页的手机注册点击*/
            if (typeof window.SendEvent !== 'undefined') {
                // window.SendEvent(11, 91);
            }
        });

        // me.control.monitorList['hj_reg'] = function () { /* 注册沪江页展示            */
        //     if (typeof window.SendEvent !== 'undefined') {
        //         window.SendEvent(2, 4)
        //     }
        // };
    ...
    hui.HJ_QuickLogin.prototype = {
        ...
        getTpl: function () {
            var tpl =
                ...
                '                   <label class="hui_checkbox_label">同意沪江的《<a target="_blank" onclick="event.cancelBubble = true;event.stopPropagation&&event.stopPropagation();" href="http://pass.hujiang.com/signup/agreement/">用户协议</a>》</label>' +
                '               </div>' +
                '           </div>' +
                '       </div>' +
                ...
                '           <span class="hj001_span">恭喜！账号注册成功</span>' +
                '       </div>' +
                '       <div class="hj001_login_warp">' +
                '           <div class="hj001_item">' +
                '               <input ui="type:\'TextInput\',formName:\'username\',rule:\'username\',placeholder:\'用户名\',autoValidate:true,autoHideError:true,allowSpace:false,hideBlankError:true,DBC2SBC:true" type="text" class="hj001_ipt" maxlength="12" tabindex="3">' +
                ...
                '       <div class="hj001_free"><a class="hj001_free_link" target="_blank" href="#" onclick="window.hjquicklogin.control.fireGlobalMonitor(\'hj_reg_email_success_active\')"><i class="hj001_free_hot_icon">i</i> <b class="hj001_free_hot_text">Hot !</b><span class="hj001_free_tip">完善信息，免费学习感兴趣的课程！</span></a></div>' +
                '       <a href="###" ui="type:\'Button\',formName:\'submit\'" class="hj001_continue_btn" tabindex="24">继续浏览</a>' +
                '       <p class="hj001_email_txt"> 已发送邮件，<a target="_blank" href="http://www.hujiang.com" title="邮箱激活并完善信息" class="hj001_go_email">邮箱激活并完善信息</a></p>' +
                '   </div>' +
                '   <!-- 手机注册成功-->' +
        ...
        render: function (options) {
            ...
            hui.cc('hj001_free_link').href = 'http://pass.hujiang.com/q/profile/?returnurl=' + (me.returnurl ? me.returnurl : window.location.href.split('#')[0]);
            if (window.location.host.indexOf('hjclass.com') !== -1 || window.location.host.indexOf('class.hujiang.com') !== -1) {
                hui.cc('hj001_free').style.display = 'none';
            }
        ...
        showDialog: function (module_name, inner) {
            ...
            if (!module) {
                ...
                me.fireGlobalMonitor('hj_reg_close');
            }
            ...
            if (module) {
                ...
                if (module_name == 'hj_reg_mobile_success') {
                    ...
                    me.fireGlobalMonitor('hj_reg_mobile_success');
                    ...
                    me.fireGlobalMonitor('hj_reg_email_success');
                    ...
                    if (inner !== 'inner') {
                        ...
                        me.fireGlobalMonitor('hj_reg_mobile_email');
                    }
                    ...
                    me.fireGlobalMonitor('hj_reg_login');
    ...
    hui.HJ_Reg_mobile.prototype = {
        ...
        onsubmit: function () {
            ...
            me.parentControl.fireGlobalMonitor('hj_reg_mobile_submit');
        ...
        sendSms: function () {
            ...
            me.parentControl.fireGlobalMonitor('hj_reg_mobile_sendsms');
    ...
    hui.HJ_Reg_email.prototype = {
        ...
        onsubmit: function () {
            ...
            me.parentControl.fireGlobalMonitor('hj_reg_email_submit');
    ...
    hui.HJ_Reg_login.prototype = {
        ...
        onLoginSubmit: function () {
            ...
            me.parentControl.fireGlobalMonitor('hj_reg_login_submit');
    ...
    hui.HJ_Reg_onekey.prototype = {
        ...
        sendSms: function () {
            ...
            if (mobile.validate()) {
                ...
                var validationcode = me.getByFormName('validationcode').mainFocus();
    ...
    hui.HJ_Reg_email_success.prototype = {
        ...
        onsubmit: function () {
            ...
            me.parentControl.fireGlobalMonitor('hj_reg_email_continue');
        ...
        onEmailActive: function () {
            ...
            me.parentControl.fireGlobalMonitor('hj_reg_email_success_active');
        },
...
hui.util.importCssString(
    ...
    '.hj001_login_box .hj001_icon_right {width: 20px; height: 20px; display: inline-block; background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:0px -100px;}' +
    '.hj001_login_box .hj001_icon_error {width: 20px; height: 20px; display: inline-block; background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-50px -100px;}' +
    '.hj001_login_box .hj001_icon_ok {display: inline-block; width: 33px; height: 33px; background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-100px -100px; vertical-align: middle; margin-top: -12px; margin-right: 10px;}' +
    ...
    '.hj001_login_box .hj001_icon_baidu          {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:0px -50px;}' +
    '.hj001_login_box .hj001_icon_baidu:hover    {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:0px 0px;}' +
    '.hj001_login_box .hj001_icon_douban         {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-50px -50px;}' +
    '.hj001_login_box .hj001_icon_douban:hover   {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-50px 0px;}' +
    '.hj001_login_box .hj001_icon_qq             {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-100px -50px;}' +
    '.hj001_login_box .hj001_icon_qq:hover       {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-100px 0px;}' +
    '.hj001_login_box .hj001_icon_renren         {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-150px -50px;}' +
    '.hj001_login_box .hj001_icon_renren:hover   {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-150px 0px;}' +
    '.hj001_login_box .hj001_icon_weibo          {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-200px -50px;}' +
    '.hj001_login_box .hj001_icon_weibo:hover    {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-200px 0px;}' +
    '.hj001_login_box .hj001_icon_zhifu          {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-250px -50px;}' +
    '.hj001_login_box .hj001_icon_zhifu:hover    {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-250px 0px;}' +
    '.hj001_login_box .hj001_success {height: 33px; overflow: hidden; /* text-align: left; */ padding: 79px 0 35px 0px;}' +
    '.hj001_login_box .hj001_success .hj001_span {line-height: 33px; font-family: "Helvetica","Microsoft Yahei","Arial";*font-family: "Microsoft Yahei","Arial"; font-size: 28px; height: 33px; color: #68c04a; text-align: center; display: inline-block;}' +
    '.hj001_login_box .hj001_view_btn {margin-top: 45px;}' +
    '.hj001_login_box .hj001_free {padding-left:30px;height: 38px;}' +
    '.hj001_login_box .hj001_free .hj001_free_link:hover .hj001_free_tip{text-decoration: underline;}' +
    '.hj001_login_box .hj001_free .hj001_free_hot_icon{border: 9px solid #FF670C;width: 34px;height: 0px;border-right-color: white;border-left: 0px;border-right-width: 6px;overflow: hidden;display: inline-block;float: left;}' +
    '.hj001_login_box .hj001_free .hj001_free_hot_text{float: left;margin-left: -34px;font-size: 12px;color: white;margin-top: 2px;font-family: arial;}' +
    '.hj001_login_box .hj001_free .hj001_free_tip{color: rgb(255, 103, 12);font-size: 14px;line-height: 16px;float: left;margin-left: 3px;margin-top: 1px;cursor:pointer; white-space:nowrap;}' +
    ...
    '.hj001_login_box .hui_textinput {font-family: Arial;background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:1000px 1000px;background-repeat:no-repeat;*margin-left: -5px;}' +
    ...
    '.hj001_login_box .hui_textinput_eye       {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-290px -40px;}' +
    '.hj001_login_box .hui_textinput_eye:hover {background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-290px 10px;}' +
    '.hj001_login_box .validate_waiting .validate_icon {position: absolute; right: 2px; top: 11px; background-image: url("http://pass.hujiang.com/quick/img/loading.gif"); display: inline-block; height: 20px; width: 20px;}' +
    '.hj001_login_box .validate_waiting .validate_text {display: none;}' +
    '.hj001_login_box .validate_ok .validate_icon {position: absolute; right: 2px; top: 11px; background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:0px -100px; display: inline-block; height: 20px; width: 20px;}' +
    ...
    '.hj001_login_box .validate_error .validate_icon {position: absolute; right: 2px; top: 11px; background-image: url("http://pass.hujiang.com/quick/img/icon.png");background-position:-50px -100px; display: inline-block; height: 20px; width: 20px;}' +
